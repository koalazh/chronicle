...
V1 选择清晰的时间窗和少量关键节点，不试图覆盖整部明末史。V2 在同一
Source Pack 上增加一个 Entry 和有限的 Worldline ledger，不把 Entry 误写成
历史事实，也不自动补写来源未支持的连续行动。正月初一、山西战事、朝廷南迁
讨论、东线防务与三月十九日的结局分别由 Source Pack 中的事件和断言承载。
